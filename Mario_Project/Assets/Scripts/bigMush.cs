...
public class bigMush : MonoBehaviour
{
    ...
    public void fireRay()
    {
        ...
        if(playerLeft.collider != null && powerupControl.bigMushroomEquipped == false)
        {
            powerupControl.bigMushroomEquipped = true;
            powerupControl.StartCoroutine("getShroom");
            manager.addScore(1000);
            Destroy(this.gameObject);
        }
        else if(playerRight.collider != null && powerupControl.bigMushroomEquipped == false)
        {
            powerupControl.bigMushroomEquipped = true;
            powerupControl.StartCoroutine("getShroom");
            manager.addScore(1000);
        ...
        if(playerUp.collider != null && powerupControl.bigMushroomEquipped == false)
        {
            powerupControl.bigMushroomEquipped = true;
            powerupControl.StartCoroutine("getShroom");
            manager.addScore(1000);
        ...
        else if(playerDown.collider != null && powerupControl.bigMushroomEquipped == false)
        {
            powerupControl.bigMushroomEquipped = true;
            powerupControl.StartCoroutine("getShroom");
            manager.addScore(1000);
